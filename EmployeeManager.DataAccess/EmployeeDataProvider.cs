    ...
    public class EmployeeDataProvider : IEmployeeDataProvider
    {
        public IEnumerable<Employee> LoadEmployees()
        {
            return new List<Employee>
            {
                ...
                {
                    Id = 6,
                    FirstName = "FuckinStan",
                    EntryDate = new DateTime(2021, 12, 17),
                    IsCoffeeDrinker= false,
                    JobRoleId = 2
                },
                new Employee
                {
                    Id = 7,
                    FirstName = "Poggy Ball",
                    EntryDate = new DateTime(2018, 07, 17),
                    IsCoffeeDrinker= true,
                    JobRoleId = 5
                }
            };
            ...
            return new List<JobRole>
              {
                ...
                new JobRole{ Id = 5, RoleName = "Personal Assistant"}
              };
        }
    }
}